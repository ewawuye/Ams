...
public class RequestController {
   ...
   public ModelAndView getRequestPage(@RequestParam(value = "count",required = false ) Integer count){
	...
	User user = userservice.searchUserByName(currentPrincipalName);
        ...
        List<Request> requests =requestservice.getByDeclineAndUser(true, userId);
 ...
 return "redirect:/request/request_page";   
}
 ...
 return "redirect:/request/request_list";   
   ...
   // retrive request approved by directer and status equals true
    @RequestMapping(value = "/requestaApproveManager",method = RequestMethod.GET)
   ...
   // for request approved by directer
  ...
  return mv;   
   ...
   // decline request
    @RequestMapping(value = "/request_decline",method = RequestMethod.GET)
 ...
 return  "redirect:/request/asset_assign?act=assigned";    
          ...
          return "redirect:/request/requestaApproveManager?act=error";
     }
   }
   //  assign page request
