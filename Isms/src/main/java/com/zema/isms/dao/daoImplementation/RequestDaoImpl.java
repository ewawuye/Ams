...
public class RequestDaoImpl implements RequestDao{
 ...
 sessionFactory.getCurrentSession().update(r);
    ...
    @Override
    public List<Request> findAllRequestByDepartment(String departmentId) {
        
         Session session = sessionFactory.getCurrentSession(); 
           List<Request> listrequest = null;
           try{
          String hql= "FROM Request r LEFT JOIN FETCH r.user u LEFT JOIN FETCH u.empployee e LEFT JOIN FETCH e.department d WHERE d.departmentId =:departmentId";
          Query<Request> query =session.createQuery(hql,Request.class);
    ...
    @Override
    public List<Request> retriveByDeclineAndUser(boolean decline, String userId) {
            Session session = sessionFactory.getCurrentSession(); 
           List<Request> listrequest = null;
           try{
          String hql= "FROM Request r LEFT JOIN FETCH r.user u  WHERE r.decline =:decline AND u.userId =:userId";
          Query<Request> query =session.createQuery(hql,Request.class);
          query.setParameter("decline",decline);
