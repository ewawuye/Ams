...
private RequestDao requestdao;
  ...
  @Transactional
    ...
    public List<Request> getRequestListByDepartment(String departmentId) {
        List<Request> listrequest = null;
        try{
          listrequest =  requestdao.findAllRequestByDepartment(departmentId);
        }
         catch(NoResultException ex){
...
@Transactional
    @Override
    public List<Request> getByDeclineAndUser(boolean decline, String userId) {
     List<Request> listrequest = null;
        try{
          listrequest =  requestdao.retriveByDeclineAndUser(decline, userId);
        }
         catch(NoResultException ex){
