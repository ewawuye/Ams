                                        ...
                                        <div class="tile-body"> 
                                            ...
                                            <f:form action ="${addDocumenturl}" modelAttribute="fileBucket" method="POST" enctype="multipart/form-data" >
                                                <div class="form-row">
                                                   ...
                                                   <input name="warrantyId" type="text" value="${param.warrantyId}"  class="form-control"/> 
                                                    <div class="form-group col-md-3">
                                                 <label for="desription">Upload Document</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                           <label for="desription">Document description</label>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                                ...
                                <tr>
                                   ...
                                   <td> 
                                       <a  class ="nav-item" href="${url_edit}">Edit</a> | <a class ="nav-item" href="${url_del}">Delete</a>| <a href="${addfinanceUrl}">Add warranty</a>
                                   </td>
                                </tr>
