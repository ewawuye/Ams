...
<html>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav navbar bg-light">
                               ...
                               <s:url var="request_url" value ="/request/request_page"/> 
                                ...
                                <li class="nav-item mr-auto" ><a class ="nav-link" href="${requestlisturl}"  >Request List </a>
                                </li>
                            </ul>
 ...
 <div class ="row">
                                          <s:url var="managerUrl" value="/request/asset_assign" >
                                       <s:param name="code" value="${requests.user. empployee.code}"/>
                                   </s:url>
                                     <div class ="  col-3">
                                         <a href="${managerUrl}" class=" btn-lg btn btn-primary"  >Approve </a>
                                     </div>
