<%-- 
    ...
    Created on : Oct 1, 2019, 1:18:02 AM
    Author     : ewawuye
--%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <%-- asset search start --%>
                            <div class="tile">
                                <h4 class="tile-title">  Asset In Store By Category </h4>
                                <div class="tile-body"> 
                                    <s:url var ="reportByCatagoryUrl"  value="/report/assetInStoreReportByCatagory"/>
