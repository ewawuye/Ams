                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav  navbar bg-light">
                                <s:url var="catagoryurl" value ="/admin/catagory_reg"/>
                                <li class =" nav-item "><a  class ="nav-link " href="${catagoryurl}" >Add cataory</a>
                                </li>
                            ...
                            <!-- information content  -->
                            <div class="alert border border-primary mt-3 alert-success" role="alert">
                                <h4 class="alert-heading">Well done!</h4>
                                <p> hhhhhhhhhhhhhh hhhhhhhhhhhhhhhhh hhhhhhhhhhhhhhhh.</p>
                            ...
                            <div class="row">
                                ...
                                <c:if test="${param.act eq 'cat_reg'}">
                                    <p calss ="success"> Catagory success fully saved</p>
                                </c:if>
                            </div>
                            <!-- search user -->
                            <div class="row">
