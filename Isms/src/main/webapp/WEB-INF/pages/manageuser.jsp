                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav navbar bg-light">
                                ...
                                <li class="nav-item" ><a class ="nav-link" href="${userregurl}"  >Add User </a>
                                </li>
                                <li class =" nav-item"><a  class ="nav-link " href="${role_url}" >Manage Role</a>
                                </li>
                                <li class=" nav-item mr-auto" > <a class ="nav-link" href="${usermanageurl}" >Manage Users</a>
                                </li>
