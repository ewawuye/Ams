                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav navbar bg-light">
                              <s:url var ="orgRegUrl" value ="/organization/organization_reg"/>
                                <li class =" nav-item "><a  class ="nav-link active" href="${orgRegUrl}">Add Company </a>
                                <s:url var ="departmenturl" value ="/dept/dept_add"/>
                                
                                <li class="nav-item mr-auto" ><a class ="nav-link" href="${departmenturl}">Manage Department</a>
                                </li>
