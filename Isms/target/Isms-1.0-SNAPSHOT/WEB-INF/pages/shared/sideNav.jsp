    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="${dash_url}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
                <li><a class="app-menu__item " href="${message_url}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Messages</span></a></li>
                <li><a class="app-menu__item " href="${callander_url}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Callander</span></a></li>
                <li><a class="app-menu__item " href=""><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">News Board</span></a></li>
