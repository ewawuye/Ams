                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class =" nav-item "><a  class ="nav-link " href="${orgRegUrl}">Add Company </a>
                                    <s:url var ="departmenturl" value ="/dept/dept_add"/>
                                    <s:url var ="departmetlisturl" value ="/dept/listDepatment"/>
                                <li class="nav-item" ><a class ="nav-link" href="${departmenturl}">Department</a>
                                </li>

                                <li class="nav-item" ><a class ="nav-link" href="${departmetlisturl}">Department  list</a>
                                </li>
                            </ul>
