                        ...
                        <div class="panel-body">
                            ...
                            <%-- search field  body--%>
                               <s:url var ="SearchAssignedAssetUrl"  value="/asset/searchAssignedAsset"/>
                                 <f:form action ="${SearchAssignedAssetUrl}" method ="get">
                            <div class=" panel-body form-row ml-5">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text"  name ="deptName" class="form-control" value ="${param.deptName}" placeholder="Enter your search Department key .."/>


                                </div>
                                <div class="form-group col-md-3">

                                    <input type="text" name="catName" class="form-control" value ="${param.catName}" placeholder="Enter your search category  key .."/>
                                </div>
