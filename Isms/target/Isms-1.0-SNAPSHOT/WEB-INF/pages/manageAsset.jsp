                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav ">
                                <li class =" nav-item "><a  class ="nav-link active" href="${assetFinanceInfourl}" >Warranty  </a>
                                </li>
                                <li class="nav-item" ><a class ="nav-link" href=" ${assetFinanceInfourl}"  >Finance information pp</a>
                                </li>
                                <li class=" nav-item" > <a class ="nav-link" href="${assetmaintanaceInfourl}" >Maintenance Information</a>
                                </li>
                                <li class=" nav-item" > <a class ="nav-link" href="${assetseacr}" >finance Information</a>
                                </li>
                            </ul>
